...
Solapas = dbc.Row(dbc.Col([
        dbc.Tabs(id="tabs-ranking", active_tab='escuelas', children=[
            ...
            dbc.Tab(label='TRANSPARENCIAS', tab_id='transparencia', label_style={'background-color':NARANJA,  'border-radius': '40px', 'color': '#000', 'margin-top': "7px"},active_label_style={'border': '4px solid white'}),
            ...
            dbc.Tab(label='APIARIOS', tab_id='apiarios', label_style={'background-color':LILA,  'border-radius': '40px', 'color': '#000', 'margin-top': "7px"},active_label_style={'border': '4px solid white'}),

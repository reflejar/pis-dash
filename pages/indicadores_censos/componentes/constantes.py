...
TEXTO_HA_PROMEDIO = 'Muestra el número de hectáreas promedio por EAP según cada año en que se realizó el Censo Nacional Agropecuario.'
...
TEXTO_SUPERFICIE_TAMANIO = 'Muestra la superficie ocupada por las EAP pequeñas y las EAP grandes según cada año en que se realizó el Censo Nacional Agropecuario.'
TEXTO_TIPO_JURIDICO = 'Muestra la cantidad de EAP que están en propiedad de Personas y la cantidad que está en propiedad de Empresas según cada año en que se realizó el Censo Nacional Agropecuario.'
TEXTO_HA_TIPO_JURIDICO = 'Muestra la cantidad de superficie (hectáreas) que es propiedad de Personas y la cantidad que es propiedad de Empresas.'
...
TEXTO_HA_FORRAJERAS = 'Acá iría un textooooo, falta'

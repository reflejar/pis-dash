...
Encabezado = dbc.Row(dbc.Col([      
                    html.H3(['Censo Nacional Agropecuario', html.A("V 1.0", href="#metodologia-censo", className="btn btn-sm text-primary")], className="text-white pt-3 fw-bolder space-grotesk"),
                    html.Br(),
